...
The current v1.0 supports Android only. Future updates might consider cross-platform compatibility (Windows PC, IOS, etc.).
...
![1_initialize](DemoGIF/1_initialize.gif)

**<u>Data filtering</u>**

![2_config](DemoGIF/2_config.gif)

**<u>Test your knowledge</u>**

![3_osm](DemoGIF/3_osm.gif)

![4_satellite](DemoGIF/4_satellite.gif)
